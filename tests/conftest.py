...
def physical_2ion_plasma_state():
    ...
    data_vars = {
        ...
        'field_unit': (['time', 'radius'], np.atleast_2d([2.5])),
        'gyroradius_unit': (['time', 'radius'], np.atleast_2d([0.00257548488])),
        'gyroradius_ref': (['time', 'radius'], np.atleast_2d([0.0030595])),
        'velocity_ref': (['time', 'radius'], np.atleast_2d([3.1062112e5])),
        'debye_length_e': (['time', 'radius'], np.atleast_2d([0.000105131718458])),
        'inverse_minimum_approach': (['time', 'radius'], np.atleast_2d([1.3889205e12])),
        'collisionality_ee': (['time', 'radius'], np.atleast_2d([7.1965041617e3])),
        'collisionality_ei': (['time', 'radius'], np.atleast_2d([1.36733579e4])),
...
def dimensionless_2ion_plasma_state():
    ...
    data_vars = {
        ...
        'gyroradius_unit_norm': (['time', 'radius'], np.atleast_2d([0.00515096976])),
        'gyroradius_ref_norm': (['time', 'radius'], np.atleast_2d([0.006119])),
        'debye_length_e_unit_norm': (['time','radius'], np.atleast_2d([0.04082016526])),
        'debye_length_e_norm': (['time', 'radius'], np.atleast_2d([0.03436236])),
        ...
        'shape_factor': (['time', 'radius'], np.atleast_2d([0.84179867])),
        ...
        'collisionality_nrl_bounce_norm': (['time', 'radius'], np.atleast_2d([0.04963843])),
        'collisionality_bounce_norm': (['time', 'radius'], np.atleast_2d([0.05474895855])),
        'collisionality_ee_norm': (['time', 'radius'], np.atleast_2d([0.011584054789])),
        'collisionality_ei_norm': (['time', 'radius'], np.atleast_2d([0.022009704])),
        'collisionality_ii_norm': (['time', 'radius', 'ion'], np.expand_dims(np.atleast_2d([9.72918311e-05, 2.60025972e-03]), axis=0)),
